...
<body>
    <div id="app">
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+94705125501</a> or <span class="mailus">email us:</span> <a href="#">kirishanth05@gmail.com </a></p>
						</div>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="{{ url('/') }}">Vacation<span>Vibes</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<!-- <li class="nav-item"><a href="rooms.html" class="nav-link">Rental Units</a></li> -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						<h2 class="footer-heading"><a href="#" class="logo">Vacation Vibes</a></h2>
						<p>Discover the perfect blend of relaxation and adventure with our top-rated vacation experiences.</p>
              ...
              <li><a href="#" class="py-1 d-block">Perfect central location</a></li>
					...
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						...
						<div class="tagcloud">
	            <a href="#" class="tag-cloud-link">Rental Units</a>
